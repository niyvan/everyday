          ...
          <div class="d-flex">
              ...
              <div class="navbar-brand-box">
                  ...
                  <a href="{{ route('dashboard') }}" class="logo logo-light">
                      <span class="logo-sm">
                          <img src="{{ asset('backend/assets/images/EverydayPhone_white_small.png') }}"
                              alt="logo-sm-light" height="34">
                      </span>
                      <span class="logo-lg">
                          <img src="{{ asset('backend/assets/images/EverydayPhone_white_big.png') }}" alt="logo-light"
                              height="32">
                      </span>
                  </a>
              </div>
