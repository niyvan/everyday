                            ...
                            <div class="row">
                                    ...
                                    <div class="md-3">
                                        ...
                                        <select name="category_id" id="category_id" class="form-select select2"
                                            ...
                                            @foreach ($category as $cat)
                                                <option value="{{ $cat->id }}" @selected($cat->id == $invoice->category_id)>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="md-3">
                                        ...
                                        <select name="product_id" id="product_id" class="form-select select2"
                                            ...
                                            @foreach ($product as $prod)
                                                <option value="{{ $prod->id }}"@selected($prod->id == $invoice->product_id)>
                                                    {{ $prod->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-2">
                                    <div class="md-3">
                                        ...
                                        <i
                                            class="btn btn-secondary waves-effect waves-light fas fa-plus-circle addeventmore">
                                            Add More</i>
                                    </div>
                                </div>
                            ...
                            <form method="post" action="{{ route('invoice.store') }}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <textarea name="description" class="form-control" id="description" placeholder="Write Description Here">{{ $invoice->description }}</textarea>
                                    </div>
                                </div><br>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-3">
                                        ...
                                        <select name="paid_status" id="paid_status" class="form-select">
                                            ...
                                            <option value="{{ $payment->paid_status }} "@selected($payment->invoice_id == $invoice->id)>
                                                {{ $payment->paid_status }}
                                            </option>
                                    ...
                                    <div class="form-group col-md-9">
                                        ...
                                        <select name="customer_id" id="customer_id" class="form-select">
                                            ...
                                            <option value=" {{ $payment->customer->name }}">
                                                {{ $payment['customer']['name'] }}</option>
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
     ...
     <td>
        <input type="number" min="1" class="form-control selling_qty text-right" name="selling_qty[]" value="{{ $details->selling_qty }}">
    </td>

    <td>
        <input type="number" class="form-control unit_price text-right" name="unit_price[]" value="{{ $details->unit_price}}">
    </td>



     <td>
        <input type="number" class="form-control selling_price text-right" name="selling_price[]" value="{{ $details->selling_price}}" readonly>
    </td>
