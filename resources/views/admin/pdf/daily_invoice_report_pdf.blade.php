                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($allData as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    {{ $item['payment']['paid_amount'] }}</td>
                                                                <td class="text-center">
                                                                    @if ($item->payment->paid_status == 'partial_paid')
                                                                        <span
                                                                            class="badge bg-warning rounded-pill ">Partial
                                                                        </span>
                                                                    @elseif($item->payment->paid_status == 'full_due')
                                                                        <span
                                                                            class="badge bg-danger rounded-pill ">Due</span>
                                                            ...
                                                            @php
                                                                $total_sum += $item['payment']['paid_amount'];
                                                            @endphp
                                                        @endforeach
