                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control example-date-input" name="date"
                                            value="{{ $purchase->date }}" type="date" id="date">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="md-3">
                                        ...
                                        <input class="form-control example-date-input" name="purchase_no"
                                            value="{{ $purchase->purchase_no }}" type="text" id="purchase_no">
                                    </div>
                                </div>
                                    ...
                                    <div class="md-3">
                                        ...
                                        <select name="category_id" id="category_id" class="form-select select2"
                                            ...
                                            @foreach ($category as $cat)
                                                <option value="{{ $cat->id }}"
                                                    {{ $cat->id == $purchase->category_id ? 'selected' : '' }}>
                                                    {{ $cat->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select name="product_id" id="product_id" class="form-select select2"
                                            ...
                                            @foreach ($product as $prod)
                                                <option value="{{ $prod->id }}"
                                                    {{ $prod->id == $purchase->product_id ? 'selected' : '' }}>
                                                    {{ $prod->name }}</option>
                                            @endforeach
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
     ...
     <td>
        <input type="number" min="1" class="form-control buying_qty text-right" name="buying_qty" value="{{ $purchase->buying_qty }}">
    </td>

 <td>
        <input type="text" class="form-control" name="description" value="{{ $purchase->description }}">
    </td>
