...
class InvoiceController extends Controller
{
    public function index()
    {
        $allData = Invoice::orderBy('date', 'desc')
            ...
            ->where('status', '1')
            ->get();
        return view('admin.invoices.index', compact('allData'));
    } // End Method
    ...
    public function create()
    {
        ...
        $date = date('Y-m-d');
        return view('admin.invoices.create', compact('invoice_no', 'category', 'date', 'costomer'));
    } // End Method
    ...
    public function pendingList()
    {
        $allData = Invoice::orderBy('date', 'desc')
            ...
            ->where('status', '0')
            ->get();
        return view('admin.invoices.pending_list', compact('allData'));
    } // End Method
    ...
    public function approve($id)
    {
        ...
        return view('admin.invoices.approve', compact('invoice'));
    } // End Method
    ...
    public function printList()
    {
        $allData = Invoice::orderBy('date', 'desc')
            ...
            ->where('status', '1')
            ->get();
        return view('admin.invoices.print_list', compact('allData'));
    } // End Method
    ...
    {
        return view('admin.invoices.daily_report');
    } // End Method
    ...
    public function dailyPdf(Request $request)
    {
        ...
        $allData = Invoice::with('invoice_details')
